...
function woocommerce_preview_emails() {
	if ( isset( $_GET['preview_woocommerce_mail'] ) ) {
		...
		$email_heading = __( 'Quote Received', 'woocommerce' );

		$message  = wpautop( __( 'Thank you, we are now processing your vquote. Your quote\'s details are below.', 'woocommerce' ) );
		...
		<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee; margin: 0 0 20px" border="1" bordercolor="#eee">
			...
			<tfoot>
				<tr>
					<th colspan="2">' . __( 'Quote total:', 'woocommerce' ) . '</td>
					<td>$9.99</td>
				</tr>
			</tfoot>
		</table>';
