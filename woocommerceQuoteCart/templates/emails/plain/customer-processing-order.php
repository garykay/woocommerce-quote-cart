...
echo __( "Your Quote has been received and is now being processed. Your quote details are shown below for your reference:", 'woocommerce' ) . "\n\n";
...
echo sprintf( __( 'Quote date: %s', 'woocommerce'), date_i18n( woocommerce_date_format(), strtotime( $order->order_date ) ) ) . "\n";
